...
public class LoanService
{
    ...
    private readonly BLTeacher _teacherBL;
    private readonly BLLoanDates _loansDatesBL;
    private readonly BLCategories _categoriesBL;
    private readonly EmailService _emailService;

    public LoanService(BLLoans loansBL, BLTeacher teacherBL, BLLoanDates loansDatesBL, BLCategories bLCategories, EmailService emailService)
    {
        _loansBL = loansBL;
    ...
    internal async Task SendEmailLoanCreated(DataAccess.Domain.LoansTeacher pTeacher, LoanDates pLoanDates)
    {
